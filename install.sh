...
info "     GRANT EXECUTE ON FUNCTION pg_stat_statements_reset(oid, oid, bigint) TO your_user; -- reset (PG 12+)"
info "     GRANT EXECUTE ON FUNCTION pg_stat_statements_reset() TO your_user;              -- reset (PG 11-)"
echo ""
